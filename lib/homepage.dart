          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                child: Text("SET Locaton"),style: ElevatedButton.styleFrom(backgroundColor: Colors.blue.shade900),),
              SizedBox(
                height: 50,
              ),
              Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text(
                      "latitude: ${Provider.of<Class_Provider>(context, listen: true).lat}",style: TextStyle(color: Color(
                        0xff000000)),),
                    SizedBox(
                      height: 5,
                    ),
                    Text(
                      "longitude: ${Provider.of<Class_Provider>(context, listen: true).lon}",style: TextStyle(color: Color(
                        0xff000000)),),
                  ],
                ),
              ),
